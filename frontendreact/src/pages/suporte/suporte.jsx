    ...
    return (
        <div className="min-h-screen w-full bg-[#E8E8E8] relative flex flex-col font-['Montserrat'] overflow-x-hidden">
            <div className="absolute top-10 left-10 md:top-14 md:left-14">
                <img src="/LogoCarometro-v2.png" alt="Carometro" className="h-12 md:h-16 mix-blend-multiply opacity-90" />
            </div>
            ...
            <div className="flex-1 flex flex-col lg:flex-row items-center justify-center max-w-[1300px] w-full mx-auto px-6 py-28 lg:py-0 gap-10 lg:gap-0">
                ...
                <div className="w-full lg:w-1/2 flex flex-col items-center justify-center h-full">
                    ...
                    <p className="text-[#555555] text-center text-[17px] md:text-lg mb-12 max-w-[400px]">
                        Nosso suporte está disponível 24h para<br className="hidden md:block" /> registro e edição de contas
                    </p>
                    ...
                    <div className="flex flex-col gap-5 mb-16 self-center lg:-ml-12 w-full max-w-[320px]">
                        <div className="flex items-center gap-5">
                            ...
                            <span className="text-[#555555] text-[17px] font-medium tracking-wide">meuemailadm@gmail.com</span>
                        </div>
                        ...
                        <div className="flex items-center gap-5">
                            ...
                            <span className="text-[#555555] text-[17px] font-medium tracking-wide">+99 (99)99999-9999</span>
                        </div>
                    </div>
                ...
                <div className="w-full lg:w-1/2 flex flex-col justify-center h-full pl-0 lg:pl-16 max-w-[650px] mx-auto">
                    ...
                    <ul className="flex flex-col gap-6 text-[#555555] text-[15px] leading-relaxed font-medium">
                        <li className="flex items-start gap-2.5">
                            ...
                            <p>Não é possível se registrar sozinho(a) no Carômetro de Franca, SP. Procure um administrador nos contatos ao lado!</p>
                        </li>
                        <li className="flex items-start gap-2.5">
                            <div className="w-[5px] h-[5px] bg-[#333333] rounded-full mt-2.5 shrink-0"></div>
                            <p>O sistema é totalmente online e não depende de instalar nenhum aplicativo. Basta ter acesso à internet e um navegador atualizado para utilizar.</p>
                        </li>
                        <li className="flex items-start gap-2.5">
                            <div className="w-[5px] h-[5px] bg-[#333333] rounded-full mt-2.5 shrink-0"></div>
                            <p>O uso do sistema é exclusivo da escola. Isso significa que somente professores e gestores autorizados pelo administrador poderão acessar as informações.</p>
                        </li>
                        <li className="flex items-start gap-2.5">
                            <div className="w-[5px] h-[5px] bg-[#333333] rounded-full mt-2.5 shrink-0"></div>
                            <p>Alterações de informações sensíveis, como o e-mail de login ou o tipo de permissão de acesso, só podem ser realizadas pelo administrador.</p>
                        </li>
                        <li className="flex items-start gap-2.5">
                            <div className="w-[5px] h-[5px] bg-[#333333] rounded-full mt-2.5 shrink-0"></div>
                            <p>Se você tiver qualquer dificuldade para acessar, o primeiro passo é falar com o administrador da sua escola. Caso seja necessário suporte técnico, ele fará o encaminhamento para a equipe responsável.</p>
                        </li>
                    </ul>
                </div>
