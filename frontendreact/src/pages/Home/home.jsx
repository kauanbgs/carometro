    ...
    return (
        <div className="h-screen w-full bg-[var(--back)] flex overflow-hidden">
            ...
            <main className="flex-1 ml-16 md:ml-[22%] p-4 md:p-10 overflow-y-auto bg-[var(--background)] rounded-l-3xl flex flex-col items-center">
                ...
                <Text variant="megaTitle" className="text-left w-full ml-0 md:ml-10 lg:ml-35 text-3xl md:text-4xl lg:text-5xl mt-5">Bem vindo ao <a className="text-[var(--azulPrincipal)]">Carômetro,</a><br className="hidden md:block"/>{JSON.parse(user).name}!</Text>
