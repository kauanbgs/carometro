...
CREATE TABLE `class` (
  ...
  CONSTRAINT `class_fk_id_instructor_foreign` FOREIGN KEY (`fk_id_instructor`) REFERENCES `instructor` (`id_instructor`) ON DELETE CASCADE
...
CREATE TABLE `instructor` (
  ...
  `google_access_token` varchar(5000) DEFAULT NULL,
  `role` enum('adm','inst') DEFAULT 'inst',
...
INSERT INTO `instructor` VALUES (1,'Euller Ferreira','euller@gmail.com','123456',NULL,'adm'),(2,'Adriano Donisete','adriano@gmail.com','123456',NULL,'adm');
...
INSERT INTO `knex_migrations` VALUES (1,'01_create_instructor_table.js',1,'2026-06-02 13:09:43'),(2,'02_create_class_table.js',1,'2026-06-02 13:09:43'),(3,'03_create_student_table.js',1,'2026-06-02 13:09:44'),(4,'04_create_occurrence_table.js',1,'2026-06-02 13:09:44'),(5,'05_create_students_occurrence_table.js',1,'2026-06-02 13:09:44'),(6,'06_create_occurrence_log_table.js',1,'2026-06-02 13:09:44'),(7,'07_create_procedure_createOccurrence.js',1,'2026-06-02 13:09:44'),(8,'08_create_views_editClassPage.js',1,'2026-06-02 13:09:44'),(9,'09_create_view_readClassInstructor.js',1,'2026-06-02 13:09:44'),(10,'10_procedure_Transfer_Capacity_Log.js',1,'2026-06-02 13:09:44'),(11,'11_trg_prevent_inactive_student_occurrence.js',1,'2026-06-02 13:09:44'),(12,'20251106175102_create_docente_table.js',1,'2026-06-02 13:09:44');
...
CREATE TABLE `occurrence` (
  ...
  CONSTRAINT `occurrence_fk_id_student_foreign` FOREIGN KEY (`fk_id_student`) REFERENCES `student` (`id_student`) ON DELETE CASCADE
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`aluno`@`%`*/ /*!50003 TRIGGER `trg_prevent_inactive_student_occurrence` BEFORE INSERT ON `occurrence` FOR EACH ROW BEGIN
...
CREATE TABLE `occurrence_log` (
  ...
  CONSTRAINT `occurrence_log_fk_id_instructor_foreign` FOREIGN KEY (`fk_id_instructor`) REFERENCES `instructor` (`id_instructor`) ON DELETE CASCADE,
...
CREATE TABLE `student` (
  ...
  CONSTRAINT `student_fk_id_class_foreign` FOREIGN KEY (`fk_id_class`) REFERENCES `class` (`id_class`) ON DELETE CASCADE
...
INSERT INTO `student` VALUES (1,'Aluanan Angel de Sousa','aluanan.sousa@aluno.senai.br','11900000001','2025-01-01 11:00:00',1,1,NULL,1),(2,'Ana Carolina de Oliveira Monteiro','ana.monteiro@aluno.senai.br','11900000002','2025-01-01 11:00:00',1,2,NULL,1),(3,'Anna Vitória Martins Ramos','anna.ramos@aluno.senai.br','11900000003','2025-01-01 11:00:00',0,3,NULL,1),(4,'Arthur Cintra de Lacerda','arthur.lacerda@aluno.senai.br','11900000004','2025-01-01 11:00:00',1,4,NULL,1),(5,'Arthur Cintra Faleiros','arthur.faleiros@aluno.senai.br','11900000005','2025-01-01 11:00:00',1,5,NULL,1),(6,'Arthur Marques Santos','arthur.santos@aluno.senai.br','11900000006','2025-01-01 11:00:00',1,6,NULL,1),(7,'Bryan Miguel Moreira','bryan.moreira@aluno.senai.br','11900000007','2025-01-01 11:00:00',1,7,NULL,1),(8,'Davi Azevedo Gonçalves','davi.goncalves@aluno.senai.br','11900000008','2025-01-01 11:00:00',1,8,NULL,1),(9,'Eduardo Augusto Tognati','eduardo.tognati@aluno.senai.br','11900000009','2025-01-01 11:00:00',1,9,NULL,1),(10,'Flávio Henrique de Souza Filho','flavio.souza@aluno.senai.br','11900000010','2025-01-01 11:00:00',1,10,NULL,1),(11,'Gabriel Braz Menezes','gabriel.menezes@aluno.senai.br','11900000011','2025-01-01 11:00:00',1,11,NULL,1),(12,'Gabriel Rossi Ventura','gabriel.ventura@aluno.senai.br','11900000012','2025-01-01 11:00:00',1,12,NULL,1),(13,'Guilherme Bason Garcia Neves','guilherme.neves@aluno.senai.br','11900000013','2025-01-01 11:00:00',1,13,NULL,1),(14,'João Victor Oliveira Silva','joao.silva@aluno.senai.br','11900000014','2025-01-01 11:00:00',1,14,NULL,1),(15,'José Victor Faccirolli','jose.faccirolli@aluno.senai.br','11900000015','2025-01-01 11:00:00',1,15,NULL,1),(16,'Kauan Borges Plaza','kauan.plaza@aluno.senai.br','11900000016','2025-01-01 11:00:00',1,16,NULL,1),(17,'Kauan Henrique Melo Silva','kauan.silva@aluno.senai.br','11900000017','2025-01-01 11:00:00',1,17,NULL,1),(18,'Keliyah Cristine de Oliveira Martins','keliyah.martins@aluno.senai.br','11900000018','2025-01-01 11:00:00',1,18,NULL,1),(19,'Leonardo Alves da Silva','leonardo.silva@aluno.senai.br','11900000019','2025-01-01 11:00:00',1,19,NULL,1),(20,'Luís Pedro França Paulino','luis.paulino@aluno.senai.br','11900000020','2025-01-01 11:00:00',1,20,NULL,1),(21,'Luiz Felipe Campos Margato','luiz.margato@aluno.senai.br','11900000021','2025-01-01 11:00:00',1,21,NULL,1),(22,'Pedro Galindo Tavares','pedro.tavares@aluno.senai.br','11900000023','2025-01-01 11:00:00',1,23,NULL,1),(23,'Rafael Caíres dos Santos','rafael.santos@aluno.senai.br','11900000024','2025-01-01 11:00:00',1,24,NULL,1),(24,'Rafael Mendes Neves','rafael.neves@aluno.senai.br','11900000025','2025-01-01 11:00:00',1,25,NULL,1),(25,'Renan Vieira Mobrise','renan.mobrise@aluno.senai.br','11900000026','2025-01-01 11:00:00',1,26,NULL,1),(26,'Sofia Siqueira Belchior','sofia.belchior@aluno.senai.br','11900000027','2025-01-01 11:00:00',1,27,NULL,1),(27,'Sophia de Oliveira Ferreira','sophia.ferreira@aluno.senai.br','11900000028','2025-01-01 11:00:00',1,28,NULL,1),(28,'Ulisses Santini Gomes','ulisses.gomes@aluno.senai.br','11900000029','2025-01-01 11:00:00',1,29,NULL,1),(29,'Vinicius Soares Peroni','vinicius.peroni@aluno.senai.br','11900000030','2025-01-01 11:00:00',1,30,NULL,1),(30,'Antonio','acintra504@gmail.com','11900000031','2025-01-01 11:00:00',0,31,NULL,1);
...
CREATE TABLE `students_occurrence` (
  ...
  CONSTRAINT `students_occurrence_fk_id_student_foreign` FOREIGN KEY (`fk_id_student`) REFERENCES `student` (`id_student`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`aluno`@`%` PROCEDURE `createOccurrence`(
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`aluno`@`%` PROCEDURE `Transfer_Capacity_Log`(
    IN p_id_student INT,
...
-- Dump completed on 2026-06-02 10:11:37
